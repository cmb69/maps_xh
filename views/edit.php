...
<?endforeach?>
  <form method="post">
    ...
    <p>
      <label>
        ...
        <textarea name="title" required><?=$this->esc($map->title)?></textarea>
      </label>
    </p>
    <p>
      <label>
  ...
  <script type="text/x-template" class="maps_table_template">
    <table>
      ...
      <thead>
        <tr>
          ...
          <th></th>
          <th>
            <button class="maps_add_row" type="button"><svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 384 512" width="1em" height="1em" fill="currentColor"><title><?=$this->text("label_create_marker")?></title><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg></button>
            <button type="button" class="maps_delete_row"><svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 448 512" width="1em" height="1em" fill="currentColor"><title><?=$this->text("label_delete_marker")?></title><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M135.2 17.7L128 32 32 32C14.3 32 0 46.3 0 64S14.3 96 32 96l384 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-96 0-7.2-14.3C307.4 6.8 296.3 0 284.2 0L163.8 0c-12.1 0-23.2 6.8-28.6 17.7zM416 128L32 128 53.2 467c1.6 25.3 22.6 45 47.9 45l245.8 0c25.3 0 46.3-19.7 47.9-45L416 128z"/></svg></button>            </th>
        </tr>
      </thead>
      <tbody>
<?foreach ($markers as $marker):?>
        <tr>
          <td><input type="number" name="latitude" value="<?=$this->esc($marker->latitude)?>" min="-90" max="90" step="any"></td>
          <td><input type="number" name="longitude" value="<?=$this->esc($marker->longitude)?>" min="-180" max="180" step="any"></td>
          <td><textarea name="info"><?=$this->esc($marker->info)?></textarea></td>
          <td>
            <input type="hidden" name="show" value="0">
            <input type="checkbox" name="show" value="1" <?=$this->esc($marker->show)?>>
          </td>
          <td></td>
        </tr>
<?endforeach?>
